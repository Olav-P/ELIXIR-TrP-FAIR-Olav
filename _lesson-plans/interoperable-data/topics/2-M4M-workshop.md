...
authors:
  - 0000-0001-9114-2896
  - custom-olav-palmen-1776860481634
reviewers: null
audience:
  - >-
    This lesson plan is designed to train local trainers to facilitate M4M
    workshops in their local institutions (so a Train-the-Trainer)
  - >-
    The audience of the M4M workshop itself are twofold (you need both of them
    to be in the training): Domain experts (who represent a domain community),
    FAIR metadata experts (data stewards) who guide a discussion leading to the
    metadata requirements that meet the FAIR data needs of that domain community
additionalResources:
